...
select siparis.siparis_id, siparis.urun_id, urunler.urun_adi, urunler.fiyat, siparis.toplam_fiyat, siparis.adres from
urunler left join siparis on urunler.urun_id=siparis.urun_id;

select siparis.siparis_id, siparis.urun_id, urunler.urun_adi, urunler.fiyat, siparis.toplam_fiyat, siparis.adres from
urunler right join siparis on urunler.urun_id=siparis.urun_id;

select siparis.siparis_id, siparis.urun_id, urunler.urun_adi, urunler.fiyat, siparis.toplam_fiyat, siparis.adres from
urunler inner join siparis on urunler.urun_id=siparis.urun_id;
